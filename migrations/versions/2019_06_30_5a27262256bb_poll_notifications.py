...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('poll_id', 'chat_id', name='one_notification_per_poll_and_chat')
    )
    op.create_index(op.f('ix_notification_poll_id'), 'notification', ['poll_id'], unique=False)
    op.add_column('poll', sa.Column('next_notification', sa.DateTime(), nullable=True))
    op.alter_column('poll', 'due_date',
