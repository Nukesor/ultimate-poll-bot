...
def upgrade():
    ...
    op.create_unique_constraint('one_vote_per_option_and_user', 'vote', ['user_id', 'poll_id', 'option_id'])
    op.create_foreign_key('vote_option_id_fkey', 'vote', 'option', ['option_id'], ['id'], ondelete='cascade')
...
def downgrade():
    ...
    op.create_index(op.f('ix_vote_poll_option_id'), 'vote', ['poll_option_id'], unique=False)
    op.create_foreign_key('vote_poll_option_id_fkey', 'vote', 'poll_option', ['poll_option_id'], ['id'], ondelete='cascade')
