...
def upgrade():
    ...
    op.add_column('reference', sa.Column('message_dc_id', sa.BigInteger(), nullable=True))
    op.add_column('reference', sa.Column('message_access_hash', sa.BigInteger(), nullable=True))
    ...
    op.execute("UPDATE reference SET type = 'inline' WHERE inline_message_id is not NULL");
