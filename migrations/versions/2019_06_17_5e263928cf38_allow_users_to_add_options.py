...
def upgrade():
    ...
    op.add_column('poll', sa.Column('allow_new_options', sa.Boolean(), server_default='false', nullable=False))
    op.add_column('poll', sa.Column('uuid', postgresql.UUID(as_uuid=True), server_default=sa.text('gen_random_uuid()'), nullable=False))
