...
def upgrade():
    ...
    op.add_column('reference', sa.Column('vote_message_id', sa.BigInteger(), nullable=True))
    op.add_column('reference', sa.Column('vote_user_id', sa.BigInteger(), nullable=True))
    op.create_index(op.f('ix_reference_admin_user_id'), 'reference', ['admin_user_id'], unique=False)
    op.create_index(op.f('ix_reference_vote_user_id'), 'reference', ['vote_user_id'], unique=False)
...
def downgrade():
    ...
    op.add_column('reference', sa.Column('admin_chat_id', sa.BIGINT(), autoincrement=False, nullable=True))
